				...
				<div class="col-md-3 col-sm-3">
					<article data-style="" class="mec-event-article sm-event-article mec-clear ">
						<div class="mec-event-image sm-event-image">
							<a href="<?php echo '/gast/' . strtolower(um_filtered_value('user_login')) ?>" 2 title="<?php echo esc_attr(um_user('display_name')); ?>"><?php echo um_user('cover_photo'); ?></a>
						</div>
						<div class="mec-event-content sm-event-content">
							...
							<h4 class="mec-event-title sm-event-title"><a class="mec-color-hover" data-event-id="2570" href="<?php echo um_user_profile_url(); ?>">
									<?php
									$key = 'description';
									$value = um_filtered_value($key);
									if ($value)
						...
						<div class="mec-event-footer sm-event-footer">
							...
							<a class="mec-booking-button sm-booking-button" data-event-id="2570" href="<?php echo '/gast/' . strtolower(um_filtered_value('user_login')) ?>" target="_self">LÆS
								MERE</a>
						</div>
					</article>
				</div>
